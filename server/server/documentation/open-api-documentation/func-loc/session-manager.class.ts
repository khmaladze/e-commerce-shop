...
export class SessionManager {
  ...
  public async locate(
    ...
    const functions = properties.internalProperties.find(
    ...
    if (opts?.closure) {
      ...
      const properties2Object = properties2.result.find(
        (el: any) => el.value.description === closure
      );
      ...
      const properties3Object = properties3.result.find(
        (el: any) => el.name === opts.paramName
      );
